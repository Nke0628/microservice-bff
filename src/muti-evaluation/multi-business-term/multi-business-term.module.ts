...
import { MultiBusinessTermResolver } from './controller/multi-business-term.resolvers';
...
@Module({
  ...
  providers: [MultiBusinessTermResolver, MultiTermService],
})
export class MultiBusinessTermModule {}
